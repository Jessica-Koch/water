...
var uiUtils = {
    createElem: function(className, idName, text, dynText){
    ...
    createCheckBox: function(className, idName, type, name) {
    ...
    createButton: function (className, idName, typ, val){
